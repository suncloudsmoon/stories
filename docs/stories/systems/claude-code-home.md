...
- `.claude-plugin/plugin.json` — the manifest (name, version, description, license, repo links; hand-synced with the Codex manifest). Beside it, `.claude-plugin/marketplace.json` is the marketplace entry Claude Code installs from.
